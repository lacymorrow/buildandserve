...
type TailwindPluginAPI = import("tailwindcss/types/config").PluginAPI;
...
function addVariablesForColors(api: TailwindPluginAPI) {
	const allColors = flattenColorPalette(api.theme("colors"));
