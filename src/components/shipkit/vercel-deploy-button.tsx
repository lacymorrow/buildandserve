...
export const VercelDeployButton = ({
	...
	const handleDeploy = async () => {
		// If no projectId is provided, we'll deploy the default project
		if (!projectId) {
			toast.info("Deploying default Shipkit project");
		}

		setIsDeploying(true);
		try {
			const result = await deployToVercel(projectId || "default");
