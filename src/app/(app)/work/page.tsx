...
import { ArrowLeft, ArrowRight, Calendar, Users, Zap, CreditCard, MessageSquare, Gamepad2 } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description: "Featured work and case studies showcasing expertise in React, TypeScript, and modern web development",
};
...
const projects = [
  ...
  },
  {
    id: "twilio",
    title: "Twilio",
    description: "Building innovative communication tools and developer experiences with Twilio's APIs. Created hackathon projects and developer resources.",
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Featured case studies showcasing expertise in React, TypeScript, and modern web development.
            From fintech platforms serving millions to innovative hardware projects.
          </p>
        </div>
      </div>
