                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <p className="text-muted-foreground mt-2 max-w-xs text-center text-balance">We tailor every detail to fit your brand and requirements, ensuring a unique and effective solution.</p>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">We build secure applications from the ground up, protecting your data and your users.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">Performance is not an afterthought. We optimize for a lightning-fast user experience.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Reliable & Scalable</h2>
                                        <p className="text-foreground">Our infrastructure is built to scale with your business, ensuring uptime and reliability.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Collaborative Partnership</h2>
                                        <p className="text-foreground">We work with you as a true partner, providing transparency and communication every step of the way.</p>
                                    </div>
                                </div>
